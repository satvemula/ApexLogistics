...
# --- BRAND PALETTE ---
# Defining the official Apex Logistics color scheme
COLORS = {
    "NAVY": "#012A5C",
    "GOLD": "#DAA520",
    "MUTED_GOLD_BG": "#FFF8DC", # Used for lighter backgrounds
    "LIGHT_GREY": "#F5F6F8",
    "MEDIUM_GREY": "#D9D9D9",
    "GREEN": "#4BB543",
    "RED": "#D9534F",
...
# Mapping technical column names to readable labels for the UI
FEATURE_LABELS = {
...
# Actual Feature Importance (Extracted from the Databricks model training run)
FEATURE_IMPORTANCE = {
    "Feature": ["i1_dep_1_place", "i1_rcs_p", "o_dep_1_place", "i1_hops", "o_hops", "legs"],
    "Importance": [0.211, 0.187, 0.142, 0.095, 0.078, 0.055]
}

# Mock data for dropdowns (representing major hubs)
...
# ==============================================================================
st.set_page_config(
    page_title="Apex Logistics Executive Dashboard", # Rebranded Title
    page_icon="🚚",
    layout="wide",
    initial_sidebar_state="collapsed"
)

# Inject Custom CSS to force the app to match the Brand Guidelines
# This overrides Streamlit's default dark/light mode settings
st.markdown(f"""
    <style>
    /* VARIABLES */
    :root {{
